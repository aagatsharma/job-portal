...
export const invoiceFormSchema = z.object({
  ...
  createDate: z.date().refine((value) => value !== null, "Please select a date"),
  ...
  items: z.array(
    z.object({
      ...
      description: z.string().min(1, { message: "This field is required" }).nonempty(),
...
export function FormBlockWrapper({
  ...
  return (
    <section className={cn("@5xl:grid @5xl:grid-cols-6", className)}>
      ...
      <div className="col-span-4 grid grid-cols-2 gap-3 @lg:gap-4 @2xl:gap-5">{children}</div>
    </section>
  );
}

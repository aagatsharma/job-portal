...
export const metaObject = (
  ...
  return {
    title: title ? `${title} - Bidesh Online` : siteConfig.title,
    description,
    openGraph: openGraph ?? {
      title: title ? `${title} - Bidesh Online` : title,
      description,
      url: "https://isomorphic-furyroad.vercel.app",
      siteName: "Bidesh Online", // https://developers.google.com/search/docs/appearance/site-names
      images: {
